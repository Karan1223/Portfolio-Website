  ...
  return (
    <div style={{backgroundColor: `${navBg}`}} className={shadow ? 'fixed w-full h-20 shadow-xl z-[100]' : 'fixed w-full h-20 shadow-xl z-[100]'}>
      ...
      <div className={nav ? 'md:hidden fixed left-0 top-0 w-full h-screen bg-black/70' : ''}>
        <div className={nav ? 'md:fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] p-10 ease-in duration-500' 
                            : 'fixed left-[-100%] top-0 p-10 ease-in duration-500'}>
        <div>
          <div className='flex w-full items-center justify-between'>
          <Image className='rounded' src={navLogo} alt="Logo" width='60' height='50'/>
          <p className='px-0 font-semibold'>Karan Punjabi </p>
        ...
        <div className='py-4 flex flex-col'>
          ...
          <div className="flex flex-col">
            ...
            <div className='flex items-center justify-between my-4 w-full sm:w-[80%]'>
              ...
              <Link aria-label='Linkedin Profile'  href="https://www.linkedin.com/in/punjabikaran/" target='_blank'>
                <AiOutlineLinkedin/>
              </Link>
              </div>
